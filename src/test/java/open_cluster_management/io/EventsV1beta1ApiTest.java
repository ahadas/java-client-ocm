...
public class EventsV1beta1ApiTest {
    ...
    public void createEventsV1beta1NamespacedEventTest() throws ApiException {
        ...
        IoK8sApiEventsV1beta1Event response = api.createEventsV1beta1NamespacedEvent(namespace, body, pretty, dryRun, fieldManager);
    ...
    public void deleteEventsV1beta1CollectionNamespacedEventTest() throws ApiException {
        ...
        Boolean watch = null;
        IoK8sApimachineryPkgApisMetaV1Status response = api.deleteEventsV1beta1CollectionNamespacedEvent(namespace, pretty, allowWatchBookmarks, body, _continue, dryRun, fieldSelector, gracePeriodSeconds, labelSelector, limit, orphanDependents, propagationPolicy, resourceVersion, timeoutSeconds, watch);
    ...
    public void listEventsV1beta1EventForAllNamespacesTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        IoK8sApiEventsV1beta1EventList response = api.listEventsV1beta1EventForAllNamespaces(allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, pretty, resourceVersion, timeoutSeconds, watch);
    ...
    public void listEventsV1beta1NamespacedEventTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        IoK8sApiEventsV1beta1EventList response = api.listEventsV1beta1NamespacedEvent(namespace, pretty, allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, resourceVersion, timeoutSeconds, watch);
    ...
    public void patchEventsV1beta1NamespacedEventTest() throws ApiException {
        ...
        String fieldManager = null;
        Boolean force = null;
        IoK8sApiEventsV1beta1Event response = api.patchEventsV1beta1NamespacedEvent(name, namespace, body, pretty, dryRun, fieldManager, force);
    ...
    public void replaceEventsV1beta1NamespacedEventTest() throws ApiException {
        ...
        String dryRun = null;
        String fieldManager = null;
        IoK8sApiEventsV1beta1Event response = api.replaceEventsV1beta1NamespacedEvent(name, namespace, body, pretty, dryRun, fieldManager);
    ...
    public void watchEventsV1beta1EventListForAllNamespacesTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        IoK8sApimachineryPkgApisMetaV1WatchEvent response = api.watchEventsV1beta1EventListForAllNamespaces(allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, pretty, resourceVersion, timeoutSeconds, watch);
    ...
    public void watchEventsV1beta1NamespacedEventTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        IoK8sApimachineryPkgApisMetaV1WatchEvent response = api.watchEventsV1beta1NamespacedEvent(name, namespace, allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, pretty, resourceVersion, timeoutSeconds, watch);
    ...
    public void watchEventsV1beta1NamespacedEventListTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        IoK8sApimachineryPkgApisMetaV1WatchEvent response = api.watchEventsV1beta1NamespacedEventList(namespace, allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, pretty, resourceVersion, timeoutSeconds, watch);
