...
public class AuthenticationV1beta1Api {
     ...
     */
    public com.squareup.okhttp.Call createAuthenticationV1beta1TokenReviewCall(IoK8sApiAuthenticationV1beta1TokenReview body, String dryRun, String fieldManager, String pretty, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call createAuthenticationV1beta1TokenReviewValidateBeforeCall(IoK8sApiAuthenticationV1beta1TokenReview body, String dryRun, String fieldManager, String pretty, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createAuthenticationV1beta1TokenReviewCall(body, dryRun, fieldManager, pretty, progressListener, progressRequestListener);
        return call;
     ...
     */
    public IoK8sApiAuthenticationV1beta1TokenReview createAuthenticationV1beta1TokenReview(IoK8sApiAuthenticationV1beta1TokenReview body, String dryRun, String fieldManager, String pretty) throws ApiException {
        ApiResponse<IoK8sApiAuthenticationV1beta1TokenReview> resp = createAuthenticationV1beta1TokenReviewWithHttpInfo(body, dryRun, fieldManager, pretty);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<IoK8sApiAuthenticationV1beta1TokenReview> createAuthenticationV1beta1TokenReviewWithHttpInfo(IoK8sApiAuthenticationV1beta1TokenReview body, String dryRun, String fieldManager, String pretty) throws ApiException {
        com.squareup.okhttp.Call call = createAuthenticationV1beta1TokenReviewValidateBeforeCall(body, dryRun, fieldManager, pretty, null, null);
     ...
     */
    public com.squareup.okhttp.Call createAuthenticationV1beta1TokenReviewAsync(IoK8sApiAuthenticationV1beta1TokenReview body, String dryRun, String fieldManager, String pretty, final ApiCallback<IoK8sApiAuthenticationV1beta1TokenReview> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createAuthenticationV1beta1TokenReviewValidateBeforeCall(body, dryRun, fieldManager, pretty, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<IoK8sApiAuthenticationV1beta1TokenReview>(){}.getType();
