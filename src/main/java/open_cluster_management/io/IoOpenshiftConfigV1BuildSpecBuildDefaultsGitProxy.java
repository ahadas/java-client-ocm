 ...
 */
@ApiModel(description = "GitProxy contains the proxy settings for git operations only. If set, this will override any Proxy settings for all git commands, such as git clone.   Values that are not set here will be inherited from DefaultProxy.")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2020-05-18T17:27:50.678+03:00")
public class IoOpenshiftConfigV1BuildSpecBuildDefaultsGitProxy {
  ...
  public IoOpenshiftConfigV1BuildSpecBuildDefaultsGitProxy httpProxy(String httpProxy) {
  ...
  **/
  ...
  public IoOpenshiftConfigV1BuildSpecBuildDefaultsGitProxy httpsProxy(String httpsProxy) {
  ...
  **/
  ...
  public IoOpenshiftConfigV1BuildSpecBuildDefaultsGitProxy noProxy(String noProxy) {
  ...
  **/
  ...
  public IoOpenshiftConfigV1BuildSpecBuildDefaultsGitProxy readinessEndpoints(List<String> readinessEndpoints) {
    this.readinessEndpoints = readinessEndpoints;
    return this;
  }

  public IoOpenshiftConfigV1BuildSpecBuildDefaultsGitProxy addReadinessEndpointsItem(String readinessEndpointsItem) {
  ...
  **/
  ...
  public IoOpenshiftConfigV1BuildSpecBuildDefaultsGitProxy trustedCA(IoOpenshiftConfigV1BuildSpecBuildDefaultsDefaultProxyTrustedCA trustedCA) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    IoOpenshiftConfigV1BuildSpecBuildDefaultsGitProxy ioOpenshiftConfigV1BuildSpecBuildDefaultsGitProxy = (IoOpenshiftConfigV1BuildSpecBuildDefaultsGitProxy) o;
    return Objects.equals(this.httpProxy, ioOpenshiftConfigV1BuildSpecBuildDefaultsGitProxy.httpProxy) &&
        Objects.equals(this.httpsProxy, ioOpenshiftConfigV1BuildSpecBuildDefaultsGitProxy.httpsProxy) &&
        Objects.equals(this.noProxy, ioOpenshiftConfigV1BuildSpecBuildDefaultsGitProxy.noProxy) &&
        Objects.equals(this.readinessEndpoints, ioOpenshiftConfigV1BuildSpecBuildDefaultsGitProxy.readinessEndpoints) &&
        Objects.equals(this.trustedCA, ioOpenshiftConfigV1BuildSpecBuildDefaultsGitProxy.trustedCA);
  }
  ...
  public String toString() {
    ...
    sb.append("class IoOpenshiftConfigV1BuildSpecBuildDefaultsGitProxy {\n");
