 ...
 */
@ApiModel(description = "RepositoryImportSpec describes a request to import images from a container image repository.")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2020-05-18T17:27:50.678+03:00")
public class ComGithubOpenshiftApiImageV1RepositoryImportSpec {
  @SerializedName("from")
  ...
  public ComGithubOpenshiftApiImageV1RepositoryImportSpec from(IoK8sApiCoreV1ObjectReference from) {
    this.from = from;
    return this;
  }
   ...
   * @return from
  **/
  @ApiModelProperty(required = true, value = "From is the source for the image repository to import; only kind DockerImage and a name of a container image repository is allowed")
  ...
  public ComGithubOpenshiftApiImageV1RepositoryImportSpec importPolicy(ComGithubOpenshiftApiImageV1TagImportPolicy importPolicy) {
  ...
  **/
  ...
  public ComGithubOpenshiftApiImageV1RepositoryImportSpec includeManifest(Boolean includeManifest) {
  ...
  **/
  ...
  public ComGithubOpenshiftApiImageV1RepositoryImportSpec referencePolicy(ComGithubOpenshiftApiImageV1TagReferencePolicy referencePolicy) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ComGithubOpenshiftApiImageV1RepositoryImportSpec comGithubOpenshiftApiImageV1RepositoryImportSpec = (ComGithubOpenshiftApiImageV1RepositoryImportSpec) o;
    return Objects.equals(this.from, comGithubOpenshiftApiImageV1RepositoryImportSpec.from) &&
        Objects.equals(this.importPolicy, comGithubOpenshiftApiImageV1RepositoryImportSpec.importPolicy) &&
        Objects.equals(this.includeManifest, comGithubOpenshiftApiImageV1RepositoryImportSpec.includeManifest) &&
        Objects.equals(this.referencePolicy, comGithubOpenshiftApiImageV1RepositoryImportSpec.referencePolicy);
  }

  @Override
  public int hashCode() {
    return Objects.hash(from, importPolicy, includeManifest, referencePolicy);
  }
  ...
  public String toString() {
    ...
    sb.append("class ComGithubOpenshiftApiImageV1RepositoryImportSpec {\n");
