...
**spec** | [**IoOpenshiftTunedV1TunedSpec**](IoOpenshiftTunedV1TunedSpec.md) |  |  [optional]
**status** | **Object** | Status is the current state of Tuned. This cannot be overriden. |  [optional]
