...
# IoOpenshiftOperatorV1OpenShiftAPIServerStatus
...
**latestAvailableRevision** | **Integer** | latestAvailableRevision is the latest revision used as suffix of revisioned secrets like encryption-config. A new revision causes a new deployment of pods. |  [optional]
