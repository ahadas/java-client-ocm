...
# IoOpenshiftConfigV1FeatureGate
...
**spec** | [**IoOpenshiftConfigV1FeatureGateSpec**](IoOpenshiftConfigV1FeatureGateSpec.md) |  | 
**status** | **Object** | status holds observed values from the cluster. They may not be overridden. |  [optional]
