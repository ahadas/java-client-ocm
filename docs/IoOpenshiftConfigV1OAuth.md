...
**spec** | [**IoOpenshiftConfigV1OAuthSpec**](IoOpenshiftConfigV1OAuthSpec.md) |  | 
**status** | **Object** | OAuthStatus shows current known state of OAuth server in the cluster |  [optional]
