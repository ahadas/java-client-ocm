...
> IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIService createApiregistrationV1beta1APIService(body, pretty, dryRun, fieldManager)
...
//import open_cluster_management.io.ApiregistrationV1beta1Api;
...
try {
    IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIService result = apiInstance.createApiregistrationV1beta1APIService(body, pretty, dryRun, fieldManager);
...
> IoK8sApimachineryPkgApisMetaV1Status deleteApiregistrationV1beta1CollectionAPIService(pretty, allowWatchBookmarks, body, _continue, dryRun, fieldSelector, gracePeriodSeconds, labelSelector, limit, orphanDependents, propagationPolicy, resourceVersion, timeoutSeconds, watch)
...
try {
    IoK8sApimachineryPkgApisMetaV1Status result = apiInstance.deleteApiregistrationV1beta1CollectionAPIService(pretty, allowWatchBookmarks, body, _continue, dryRun, fieldSelector, gracePeriodSeconds, labelSelector, limit, orphanDependents, propagationPolicy, resourceVersion, timeoutSeconds, watch);
    System.out.println(result);
} catch (ApiException e) {
...
> IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIServiceList listApiregistrationV1beta1APIService(pretty, allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, resourceVersion, timeoutSeconds, watch)
...
Boolean watch = true; // Boolean | Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
try {
    IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIServiceList result = apiInstance.listApiregistrationV1beta1APIService(pretty, allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, resourceVersion, timeoutSeconds, watch);
    System.out.println(result);
} catch (ApiException e) {
...
> IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIService patchApiregistrationV1beta1APIService(name, body, pretty, dryRun, fieldManager, force)
...
try {
    IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIService result = apiInstance.patchApiregistrationV1beta1APIService(name, body, pretty, dryRun, fieldManager, force);
    System.out.println(result);
} catch (ApiException e) {
...
> IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIService patchApiregistrationV1beta1APIServiceStatus(name, body, pretty, dryRun, fieldManager, force)
...
Boolean force = true; // Boolean | Force is going to \"force\" Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
try {
    IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIService result = apiInstance.patchApiregistrationV1beta1APIServiceStatus(name, body, pretty, dryRun, fieldManager, force);
    System.out.println(result);
} catch (ApiException e) {
...
> IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIService replaceApiregistrationV1beta1APIService(name, body, pretty, dryRun, fieldManager)
...
String fieldManager = "fieldManager_example"; // String | fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
try {
    IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIService result = apiInstance.replaceApiregistrationV1beta1APIService(name, body, pretty, dryRun, fieldManager);
    System.out.println(result);
} catch (ApiException e) {
...
> IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIService replaceApiregistrationV1beta1APIServiceStatus(name, body, pretty, dryRun, fieldManager)
...
String fieldManager = "fieldManager_example"; // String | fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
try {
    IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIService result = apiInstance.replaceApiregistrationV1beta1APIServiceStatus(name, body, pretty, dryRun, fieldManager);
    System.out.println(result);
} catch (ApiException e) {
...
> IoK8sApimachineryPkgApisMetaV1WatchEvent watchApiregistrationV1beta1APIService(name, allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, pretty, resourceVersion, timeoutSeconds, watch)
...
Boolean watch = true; // Boolean | Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
try {
    IoK8sApimachineryPkgApisMetaV1WatchEvent result = apiInstance.watchApiregistrationV1beta1APIService(name, allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, pretty, resourceVersion, timeoutSeconds, watch);
    System.out.println(result);
} catch (ApiException e) {
...
> IoK8sApimachineryPkgApisMetaV1WatchEvent watchApiregistrationV1beta1APIServiceList(allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, pretty, resourceVersion, timeoutSeconds, watch)
...
Boolean watch = true; // Boolean | Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
try {
    IoK8sApimachineryPkgApisMetaV1WatchEvent result = apiInstance.watchApiregistrationV1beta1APIServiceList(allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, pretty, resourceVersion, timeoutSeconds, watch);
    System.out.println(result);
} catch (ApiException e) {
