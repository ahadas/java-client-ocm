...
> IoK8sApiAuthorizationV1LocalSubjectAccessReview createAuthorizationV1NamespacedLocalSubjectAccessReview(namespace, body, dryRun, fieldManager, pretty)
...
//import open_cluster_management.io.AuthorizationV1Api;
...
try {
    IoK8sApiAuthorizationV1LocalSubjectAccessReview result = apiInstance.createAuthorizationV1NamespacedLocalSubjectAccessReview(namespace, body, dryRun, fieldManager, pretty);
...
> IoK8sApiAuthorizationV1SelfSubjectAccessReview createAuthorizationV1SelfSubjectAccessReview(body, dryRun, fieldManager, pretty)
...
String pretty = "pretty_example"; // String | If 'true', then the output is pretty printed.
try {
    IoK8sApiAuthorizationV1SelfSubjectAccessReview result = apiInstance.createAuthorizationV1SelfSubjectAccessReview(body, dryRun, fieldManager, pretty);
    System.out.println(result);
} catch (ApiException e) {
...
> IoK8sApiAuthorizationV1SelfSubjectRulesReview createAuthorizationV1SelfSubjectRulesReview(body, dryRun, fieldManager, pretty)
...
String pretty = "pretty_example"; // String | If 'true', then the output is pretty printed.
try {
    IoK8sApiAuthorizationV1SelfSubjectRulesReview result = apiInstance.createAuthorizationV1SelfSubjectRulesReview(body, dryRun, fieldManager, pretty);
    System.out.println(result);
} catch (ApiException e) {
...
> IoK8sApiAuthorizationV1SubjectAccessReview createAuthorizationV1SubjectAccessReview(body, dryRun, fieldManager, pretty)
...
String pretty = "pretty_example"; // String | If 'true', then the output is pretty printed.
try {
    IoK8sApiAuthorizationV1SubjectAccessReview result = apiInstance.createAuthorizationV1SubjectAccessReview(body, dryRun, fieldManager, pretty);
    System.out.println(result);
} catch (ApiException e) {
