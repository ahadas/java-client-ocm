...
------------ | ------------- | ------------- | -------------
**allocatable** | [**IoK8sApiStorageV1beta1VolumeNodeResources**](IoK8sApiStorageV1beta1VolumeNodeResources.md) | allocatable represents the volume resources of a node that are available for scheduling. |  [optional]
